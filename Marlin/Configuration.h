...
// Disable warnings about X2 Y2 being assigned automatically 
...
#define STRING_CONFIG_H_AUTHOR "(Gwenn, CNC-SKR-1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MPCNC-SKR"
